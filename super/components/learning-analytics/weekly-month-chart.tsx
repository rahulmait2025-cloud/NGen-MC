...
import type { LearningAnalyticsWeeklyPoint } from '@/lib/superadmin/learning-analytics/types';
...
export function WeeklyMonthChart({ data, title = 'This month' }: { data: LearningAnalyticsWeeklyPoint[]; title?: string }) {
      ...
      <BentoCard>
        <div className="p-8">
          <div className="mb-6">
            ...
            <p className={chartSectionSubtitleClass}>Weekly watch hours this month</p>
          </div>
          {hasData ? (
            ...
            <div className="flex h-[200px] flex-col items-center justify-center gap-3 text-center">
              ...
              <p className="text-sm font-semibold text-muted-foreground">No data this month</p>
            </div>
          )}
        </div>
      </BentoCard>
