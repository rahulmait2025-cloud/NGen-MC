-- Phase 3: auth context performance.
-- 1) Add student_id to student auth resolver so actions can reuse resolved IDs.
-- 2) Add missing concurrent indexes for resolver and profile filters.
