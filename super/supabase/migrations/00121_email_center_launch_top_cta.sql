...
<body style="margin:0;padding:10px;background:linear-gradient(135deg, #fef5ec 0%, #ffffff 100%);font-family:Arial,Helvetica,sans-serif;">
  ...
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:linear-gradient(135deg, #fef5ec 0%, #ffffff 100%);">
    <tr>
      <td align="center" style="padding:24px 12px;">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:650px;background-color:#FFFFFF;border:1px solid #E3E4E6;border-radius:10px;overflow:hidden;box-shadow:0 10px 40px rgba(229, 140, 51, 0.12);">
          ...
          <tr>
            <td style="padding:15px 20px 25px 20px;">
          ...
          <tr>
            <td style="padding:25px 20px;background:linear-gradient(135deg, #2d3748 0%, #1a202c 100%);text-align:center;">
              <p style="margin:0 0 8px 0;font-size:12px;line-height:1.6;color:#CBD5E0;">You are receiving this email because you are part of {{program_name}} at {{college_name}}.</p>
              <p style="margin:16px 0 8px 0;font-size:12px;line-height:1.6;color:#CBD5E0;font-weight:600;">Stay Connected with Us!</p>
              <p style="margin:0 0 16px 0;font-size:12px;line-height:1.6;">
                <a href="https://www.instagram.com/code.with.ctobhaiya?igsh=MTgyM3ZyY2V6enJheQ==" style="color:#F4A854;text-decoration:none;font-weight:600;">Instagram</a>
                <span style="color:#CBD5E0;"> | </span>
                <a href="https://www.linkedin.com/in/anuj-kumar-a-k-a-cto-bhaiya-on-youtube-9a188968/" style="color:#F4A854;text-decoration:none;font-weight:600;">LinkedIn</a>
                <span style="color:#CBD5E0;"> | </span>
                <a href="https://www.youtube.com/@CodingwithCTOBhaiya" style="color:#F4A854;text-decoration:none;font-weight:600;">YouTube</a>
              </p>
              <a href="{{unsubscribe_url}}" style="font-size:12px;color:#F4A854;text-decoration:none;font-weight:600;">Unsubscribe or manage preferences</a>
            </td>
          </tr>
