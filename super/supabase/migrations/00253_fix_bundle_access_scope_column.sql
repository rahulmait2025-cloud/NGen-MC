-- Migration: 00253_fix_bundle_access_scope_column.sql
-- Description: Fix column bi.access_scope does not exist error in get_student_entitled_courses RPC by setting has_full_bundle_access to true (since the CTE already filters on bi.item_type = 'master_course').
