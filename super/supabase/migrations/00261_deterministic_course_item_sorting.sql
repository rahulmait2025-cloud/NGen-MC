-- Migration: 00261_deterministic_course_item_sorting.sql
-- Description: Enforce deterministic sorting (sort_order ASC, created_at ASC) on modules and items in get_student_course_player_payload.
...
-- Revoke and grant execute as in recent security migrations
