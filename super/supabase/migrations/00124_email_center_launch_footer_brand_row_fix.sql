              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td style="vertical-align:middle;">
                    <img src="https://nextgen-cto.in/_next/image?url=%2Fassets%2Flogo-hd.png&w=96&q=75" alt="NextGen CTO Logo" style="width:48px;height:auto;display:block;border:0;outline:none;text-decoration:none;" />
                  </td>
                  <td style="font-size:18px;font-weight:800;color:#FFFFFF;padding-left:12px;vertical-align:middle;">NextGen CTO × {{college_name}}</td>
                </tr>
              </table>
            </td>
          </tr>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto;">
                <tr>
                  <td valign="middle" style="padding-right:10px;">
                    <img src="https://nextgen-cto.in/_next/image?url=%2Fassets%2Flogo-hd.png&w=96&q=75" alt="NextGen CTO" width="56" style="display:block;border:0;outline:none;text-decoration:none;height:auto;" />
                  </td>
