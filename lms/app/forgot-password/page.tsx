...
import { getCollegeAdminPasswordResetRedirectUrl } from '@/lib/auth/college-admin-auth-urls';
...
export default function CollegeAdminForgotPasswordPage(): ReactNode {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const redirectTo = getCollegeAdminPasswordResetRedirectUrl(window.location.origin);
