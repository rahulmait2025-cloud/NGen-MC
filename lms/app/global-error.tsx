        ...
        <div className="flex min-h-screen flex-col items-center justify-center gap-6 p-6 text-center">
          ...
          <div className="space-y-2 max-w-md">
            ...
            <p className="text-muted-foreground text-sm">
              The learning platform hit an unexpected error. Try reloading the page — if it keeps happening, contact your admin.
            </p>
          </div>
          <div className="flex gap-3">
            <button
              type="button"
              onClick={reset}
              className="inline-flex items-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow hover:bg-primary/90 transition-[background-color,transform] duration-150 ease-out active:scale-[0.98]"
            >
