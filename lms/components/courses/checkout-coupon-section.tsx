...
import { validateCouponPreviewAction } from '@/app/c/[collegeSlug]/student/(public)/pillars/[pillarSlug]/courses/[courseId]/actions';
...
function CheckoutCouponForm({
  ...
  'collegeSlug' | 'pillarSlug' | 'courseId' | 'pricePlanId' | 'variantId' | 'onApplied' | 'onCleared'
>) {
  ...
  function handleApply() {
    ...
    startTransition(async () => {
      const res = await validateCouponPreviewAction(collegeSlug, pillarSlug, courseId, {
        couponCode: trimmed,
