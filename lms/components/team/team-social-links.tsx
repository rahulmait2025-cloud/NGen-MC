...
const iconLinkClassName =
  'inline-flex size-11 min-h-11 min-w-11 items-center justify-center border border-[#111111] text-[#111111] transition-colors hover:bg-[#111111] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff5f36] dark:border-[#3a3d42] dark:text-[#c5c2bc] dark:hover:bg-[#e8e5df] dark:hover:text-[#0e1013]';

const textLinkClassName =
  'inline-flex min-h-11 items-center border border-[#111111] px-4 py-2 font-display text-[11px] font-bold uppercase tracking-[0.12em] text-[#111111] transition-colors hover:bg-[#111111] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff5f36] dark:border-[#3a3d42] dark:text-[#c5c2bc] dark:hover:bg-[#e8e5df] dark:hover:text-[#0e1013]';
