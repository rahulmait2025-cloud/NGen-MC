    ...
    <section className="border-b border-[#111111] bg-[#f7f6f2] px-5 py-16 md:px-16 md:py-20 dark:border-[#2a2d32] dark:bg-[#0e1013]">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-10">
        <div className="lg:col-span-7">
          <p className="font-display text-[11px] font-bold uppercase tracking-[0.2em] text-[#737373] dark:text-[#7a7872]">
            The humans behind NextGen CTO
          </p>
          <h1 className="relative mt-5 max-w-2xl text-balance font-display text-[2.625rem] font-bold leading-[1.02] tracking-[-0.035em] text-[#111111] sm:text-[3.25rem] lg:text-6xl dark:text-[#e8e5df]">
            {settings.heroTitle}
          </h1>
          ...
          <p className="mt-6 max-w-xl text-base leading-relaxed text-[#555555] md:text-lg dark:text-[#9a9790]">
