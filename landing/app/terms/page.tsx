...
export const metadata = {
    title: "Terms and Conditions | NextGen CTO",
    description: "Terms and Conditions for NextGen CTO learning management platform.",
};
            ...
            <main>
                ...
                <section className="relative pt-40 pb-20 px-6 overflow-hidden border-b border-primary/5">
                    <div className="absolute inset-0 pointer-events-none flex justify-center">
                        <div className="w-[1000px] h-[600px] bg-primary/10 rounded-full blur-[120px] -mt-40 opacity-30" />
                    </div>
                            ...
                            <div className="lg:col-start-4 lg:col-span-9">
                                <Reveal delay={0}>
                                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-[10px] font-black uppercase tracking-widest mb-6">
                                        <FileText className="h-3 w-3" /> Updated April 5, 2024
                                    </div>
                                </Reveal>
                                ...
                                <Reveal delay={0.2}>
                                    <p className="text-muted-foreground text-lg md:text-xl max-w-2xl leading-relaxed">
                                        Our commitment to excellence and fairness. Please review the rules 
                                        governing your use of the NextGen CTO platform.
                                    </p>
                                </Reveal>
                            </div>
                        </div>
