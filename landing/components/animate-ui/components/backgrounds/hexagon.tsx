              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    "before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-foreground/[0.04] before:opacity-100 before:transition-all before:duration-1000",
