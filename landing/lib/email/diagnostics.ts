import { inspectEmailConfig } from './config';
...
export function getEmailProviderDiagnostics(): EmailProviderDiagnostics {
  ...
  return {
    selectedProvider: inspected.selectedProvider,
    hasEmailFrom: inspected.hasEmailFrom,
    hasReplyTo: inspected.hasReplyTo,
    hasSendGridKey: inspected.hasSendGridKey,
    hasResendKey: inspected.hasResendKey,
    fromSource: inspected.fromSource,
    dryRun: inspected.isDryRun,
